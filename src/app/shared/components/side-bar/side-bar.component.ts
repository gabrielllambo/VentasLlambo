...
@Component({
  ...
  standalone: true,
  imports      : [FuseLoadingBarComponent, NgIf, FuseVerticalNavigationComponent, FuseHorizontalNavigationComponent, MatButtonModule, MatIconModule, FuseFullscreenComponent,   ShortcutsComponent, NotificationsComponent, UserComponent, RouterOutlet],
